...
public class RobotMap {
	...
	public static void init() {
		...
		LiveWindow.addActuator("DriveTrain", "LeftSpin",
				(Talon) driveTrainLeftSpin);

		driveTrainFakeWheel = new Talon(4);
		LiveWindow.addActuator("DriveTrain", "FakeWheel",
				(Talon) driveTrainFakeWheel);

		driveTrainSwerve = new RobotDrive(driveTrainLeftSpin,
				driveTrainFakeWheel);
		...
		LiveWindow.addActuator("DriveTrain", "RrightSpin",
				(Talon) driveTrainRrightSpin);
